...
When submitting issues on GitHub, do not include any sensitive data. If you have questions or issues pertaining to agency specific data, please directly contact itdb-support@gsa.gov.

Below you will find documentation outlining the GitHub Issue Process:

[Issue Work Flow](https://github.com/GSA/ITDB-schema/blob/IT-Collect-Docs/GitHubFlowChart2.jpg)

[Issue Review Process](https://github.com/GSA/ITDB-schema/blob/IT-Collect-Docs/GitHub_Flow-v2.jpg)
